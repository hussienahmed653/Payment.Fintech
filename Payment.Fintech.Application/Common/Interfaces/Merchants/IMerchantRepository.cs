...
public interface IMerchantRepository
{
    ...
    Task<Domain.Merchant> GetMerchantByGuidAsync(Guid id, CancellationToken cancellationToken = default);
    Task<IEnumerable<Domain.Merchant>> SearchAsync(string search, CancellationToken cancellationToken = default);
    Task<IEnumerable<Domain.Merchant>> FilterAsync(MerchantFilterSpecification spec, CancellationToken cancellationToken = default);
    ...
    Task UpdateMerchantAsync(Domain.Merchant merchant, CancellationToken cancellationToken = default);
    Task DeleteMerchantAsync(Domain.Merchant merchant, CancellationToken cancellationToken = default);
}
