...
internal class MerchantRepository(ApplicationDbContext context) : IMerchantRepository
{
    ...
    public async Task DeleteMerchantAsync(Merchant merchant, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<IEnumerable<Merchant>> FilterAsync(MerchantFilterSpecification spec, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<Merchant> GetMerchantByGuidAsync(Guid guid, CancellationToken cancellationToken = default) =>
        await _context.Merchants
    ...
    public async Task<IEnumerable<Merchant>> SearchAsync(string search, CancellationToken cancellationToken = default)
    {
    ...
    public async Task UpdateMerchantAsync(Merchant merchant, CancellationToken cancellationToken = default) =>
